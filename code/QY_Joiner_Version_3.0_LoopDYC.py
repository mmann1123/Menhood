...
def Select_dyc():
    ...
    while True:
        ...
        More_dyc = raw_input("Do you want to select more variable from different dataset-year-categories combination?\n\n"+
                            "Type 1 as you want to slect more\nType anything else as you don't want to slect more\n\n"+
                            "Enter here>>>>>>>>>")
        if More_dyc == "1":
            if big_i == 0:
                Joined_Pd = Join_Pd
...
Output_name = raw_input("Please type in the name of the folder where store the joined shp and description of variables__")#Get folder name
